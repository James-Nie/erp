<template>
  <div class="goodsFiles">
    ...
    <el-table :data="stockList" v-loading="loading" stripe style="width: 100%" @selection-change="handleSelectionChange">
    ...
    <el-dialog custom-class="goods-Form" :title="formTitle" :visible.sync="formVisible" :before-close="handleClose">
      <stock-form ref="goodsFilesForm" :updated_form="form" :formTitle="formTitle"></stock-form>
    </el-dialog>
  </div>
</template>
<script>
...
export default {
  ...
  methods: {
    ...
    handleDelete() {
      ...
      this.$tool.common(this, '/stock/batchDelete', {
        'goodsIds': goodsIds
      }, bodyInfo => {
        // 清空选中
    ...
    _loadMainList() {
      this.$tool.loadList(this, 'stock/list', bodyInfo => {
        this.stockList = bodyInfo.apiResult
      }, {
