<template>
  <div>
    <el-form :inline="true">
      ...
      <el-form-item>
        <el-button type="primary" @click="addQuick">添加</el-button>
      </el-form-item>
      <el-form-item>
        <el-button type="primary" @click="deleteQuick"><i class="el-icon-delete" disabled="multipleSelection.length ==0"></i>删除</el-button>
      </el-form-item>
    </el-form>
    <el-table :data="quickList" class="quickList" v-loading="loading" highlight-current-row max-height="243" @selection-change="handleSelectionChange" @row-click="updateQuick">
  ...
  methods: {
    ...
    deleteQuick() {
      ...
      this.multipleSelection.forEach(function(item) {
      	if (item.quick_uuid) {
      		quickUuids.push(item.quick_uuid)
      	}
      })
